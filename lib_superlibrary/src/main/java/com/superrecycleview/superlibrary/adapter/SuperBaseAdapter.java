...
public abstract class SuperBaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE.HEADER:// header
                baseViewHolder = new BaseViewHolder(mHeaderLayout, mCtx);
                break;
            case VIEW_TYPE.FOOTER:// footer
                baseViewHolder = new BaseViewHolder(mFooterLayout, mCtx);
                break;
            default:
     ...
     * Base api
     */
    protected abstract void convert(BaseViewHolder holder, T item, int position) throws ParseException;
