...
public class SPManager {
    private static SimpleArrayMap<String, SPManager> SP_UTILS_MAP = new SimpleArrayMap<>();
    private SharedPreferences sp;
    /**
     * 获取 SP 实例
     *
     * @return {@link SPManager}
     */
    ...
    public static SPManager getInstance(String spName) {
        if (isSpace(spName)) spName = "system_setting";
        SPManager spUtils = SP_UTILS_MAP.get(spName);
        if (spUtils == null) {
            spUtils = new SPManager(spName);
            SP_UTILS_MAP.put(spName, spUtils);
        }
        return spUtils;
    }

    private SPManager(final String spName) {
        sp = ContextUtil.getmCtx().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
